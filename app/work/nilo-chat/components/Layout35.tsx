      ...
      <div className="container">
        <div className="w-full max-w-md">
          ...
          <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            The business wanted it. The client was aligned. But the people who
            actually run the operation could shut it all down.
          </h2>
          <p className="md:text-md">
            Grupo Fleury was the ideal pilot partner — leadership already
          ...
          <p className="mt-4 md:text-md">
            ...
            could earn their trust at Fleury, it would work everywhere.
          </p>
        </div>
      </div>
    </section>
