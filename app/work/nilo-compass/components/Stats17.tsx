        ...
        <div className="grid grid-cols-1 items-center gap-y-12 lg:grid-cols-2 lg:gap-x-20">
          <div>
            ...
            <p className="text-white/80 md:text-md">
              ...
              highly specific metrics that hadn't yet been implemented. Managers
              reported being able to understand their operations without needing
              help interpreting data. They could build reports for directors and
          ...
          <div className="grid grid-cols-1 gap-y-8 py-2 md:grid-cols-2 md:gap-x-8 md:gap-y-12">
            ...
            <div className="border-l-2 border-white/30 pl-8">
              ...
              <h3 className="text-md font-bold leading-[1.4] text-white/80 md:text-xl">
                Use cases live by end of project, each with 10–20 metrics
              </h3>
            </div>
          </div>
        </div>
