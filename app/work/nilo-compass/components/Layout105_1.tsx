        ...
        <div className="mb-12 grid grid-cols-1 items-start justify-between gap-x-12 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:mb-20 lg:gap-x-20">
          ...
          <div>
            ...
            <p className="mb-4 md:text-md">
              ...
              disabled, we surfaced real data in the preview.
            </p>
            <p className="md:text-md">
              The manager could see their actual numbers, not projections, and
              understand precisely what they were leaving on the table. What
              started as a way to handle an incomplete contract scenario
              became a deliberate upsell opportunity built into the product
              itself.
            </p>
          </div>
        </div>
