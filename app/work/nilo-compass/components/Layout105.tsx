        ...
        <div className="mb-12 grid grid-cols-1 items-start justify-between gap-x-12 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:mb-20 lg:gap-x-20">
          ...
          <div>
            <p className="mb-4 md:text-md">
              ...
              themed dashboards, not a blank canvas.
            </p>
            <p className="mb-5 md:mb-4 md:text-md">
              Each theme had a curated set of metrics, pre-defined
              visualizations, and contextual signals that indicated whether a
              number was good, critical, or required attention. Managers
              didn't need to configure anything. They opened Compass and the
